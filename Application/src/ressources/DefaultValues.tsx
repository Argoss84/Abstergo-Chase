...
export const DEFAULT_OBJECTIVE_ZONE_RADIUS = 300; // Rayon de la zone d'objectif (en mètres)
export const DEFAULT_ROGUE_RANGE = 50; // Portée des Rogues (en mètres)
export const DEFAULT_AGENT_RANGE = 50; // Portée des Agents (en mètres)
